...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#f9f9f9] py-12 px-4">
      <motion.div 
      ...
      >
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold font-['Manrope'] text-[#181f21]">Join the Mission</h1>
          <p className="text-[#586062] mt-2">Create an account to track scores, win rewards, and support charities.</p>
        </div>
        ...
        <form onSubmit={handleSignup} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[#434749] mb-2">First Name</label>
              <input
                type="text"
                value={firstName}
            ...
            <div>
              <label className="block text-sm font-medium text-[#434749] mb-2">Last Name</label>
              <input
                type="text"
                value={lastName}
        ...
        <p className="mt-8 text-center text-sm text-[#586062]">
          ...
          <Link href="/login" className="text-[#46645c] font-medium hover:underline">
            Sign in
          </Link>
        </p>
      </motion.div>
